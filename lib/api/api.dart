...
class ApiRest {
  ...
  Future<VivaWallet> getVivawallet(String fullName, String email, int amount,String produit) {
    return http.post("https://www.vivapayments.com/api/orders", headers: {
