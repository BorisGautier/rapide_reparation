...
List _modelePhone =
  ...
  List _modeleOrdi =
  ["modele11", "modele22", "modele33", "modele44", "modele55"];

  List _modeleTab =
  ["modele111", "modele222", "modele333", "modele444", "modele555"];

  List _degat =
  ["Connecteur", "Ecran cassé"];
      ...
      body: ListView(
        ...
        image: DecorationImage(
          ...
          fit: BoxFit.cover,
                ...
                Container(
                  child: Text("Choississez le modèle de votre" + " " + appareil,style: TextStyle(fontStyle: FontStyle.italic,fontWeight: FontWeight.bold)),
                ),
                Divider(
                  color: Colors.transparent,
                  height: 10,
              ...
              onChanged: changedDropDownItem,
                ...
                Text("Quel est votre problème?",style: TextStyle(fontStyle: FontStyle.italic,fontWeight: FontWeight.bold)),
                 Divider(
                  color: Colors.transparent,
                ),
                DropdownButton(
                ...
                Center(
                        ...
                        child: new FlatButton(
                          ...
                          onPressed: () =>   Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        TechnicienPage(appareil: appareil,modele: modele,probleme: probleme,ecran:ecran)), //MaterialPageRoute
                              ),
                          child: new Container(
