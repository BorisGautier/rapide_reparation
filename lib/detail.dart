...
class DetailPage extends StatefulWidget {
  DetailPage(
      {Key key, this.appareil, this.modele, this.probleme, this.ecran,this.pb,this.rdv,this.date,this.societe,
      this.prix,this.adresse,this.code,this.etage,this.infos})
      : super(key: key);

  final String appareil, modele, probleme, ecran,pb,rdv,date,societe,prix,adresse,code,etage,infos;
  @override
  _DetailPage createState() => _DetailPage(appareil, modele, probleme, ecran,pb,rdv,date,societe,prix,adresse,code,etage,infos);
}

class _DetailPage extends State<DetailPage> {
   _DetailPage(this.appareil, this.modele, this.probleme, this.ecran,this.pb,this.rdv,this.date,this.societe,this.prix,this.adresse,this.code,this.etage,this.infos);
   String appareil, modele, probleme, ecran,pb,rdv,date,societe,prix,adresse,code,etage,infos;
  ...
  confirmer() {
    ...
    if(rdv == "domicile") {
      setState(() => _isLoading1 = false);
              ...
              context,
              MaterialPageRoute(
                builder: (context) => StripePage(appareil: appareil,date: date,ecran: ecran,modele: modele,pb: pb,probleme: probleme,rdv: rdv,societe:societe,adresse: adresse,prix: pri.toString(),code:code,etage:etage,infos:infos)
              ),
            );
    }
    else{
