...
Firestore.instance
    ...
    api.getVivawallet("Rapide réparation", currentUser.email, pf,modele).then((VivaWallet response) {
      if (response.success) {
        setState(() => _isLoading1 = false);
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => PayPalPage(url: "https://www.vivapayments.com/web/checkout?ref=$code"),
          ),
        );
      } else {
        setState(() => _isLoading1 = false);
