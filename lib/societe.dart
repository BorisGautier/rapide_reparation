...
class SocietePage extends StatefulWidget {
  SocietePage(
      ...
      this.rdv,
      this.date,
      this.prix,this.adresse})
      : super(key: key);

  final String appareil, modele, probleme, ecran, pb, rdv, date, prix,adresse;
  @override
  _SocietePage createState() =>
      _SocietePage(appareil, modele, probleme, ecran, pb, rdv, date, prix,adresse);
}

class _SocietePage extends State<SocietePage> {
  _SocietePage(this.appareil, this.modele, this.probleme, this.ecran, this.pb,
      this.rdv, this.date, this.prix,this.adresse);
  String appareil, modele, probleme, ecran, pb, societe, rdv, date, prix,adresse;
