...
class TelephonePage extends StatefulWidget {
  @override
  _TelephonePage createState() => _TelephonePage();
}

class _TelephonePage extends State<TelephonePage> {
                ...
                new Container(
                  ...
                  child: new Column(
                    children: <Widget>[
                      ...
                      Text("Marque de votre téléphone",
                          style: TextStyle(
                              fontStyle: FontStyle.italic,
                              fontWeight: FontWeight.bold)),
                      ...
                      Text("Modèle de votre téléphone",
                          style: TextStyle(
                              fontStyle: FontStyle.italic,
                              fontWeight: FontWeight.bold)),
                      i
    ...
    setState(() {
      ...
      if (val == "407") {
        ...
        if (_currentModele == _dropDownMenuItems[0].value) {
          ...
          modele = "534";
          bu = true;
        } else if (_currentModele == _dropDownMenuItems[10].value) {
          modele = "526";
          bu = true;
        }
      } else if (val == "409") {
